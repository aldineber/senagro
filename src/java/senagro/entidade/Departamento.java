...
@NamedQueries({
    ...
    @NamedQuery(name = "Departamento.findByProveedorIdProveedor", query = "SELECT d FROM Departamento d WHERE d.proveedorIdProveedor = :proveedorIdProveedor"),
...
public class Departamento implements Serializable {
    ...
    public Departamento(Integer idDepartamento, int proveedorIdProveedor, String nombreDepartamento) {
        this.idDepartamento = idDepartamento;
    ...
    public String toString() {
        return "senagro.entidade.Departamento[ idDepartamento=" + idDepartamento + " ]";
    }
